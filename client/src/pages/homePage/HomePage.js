...
function HomePage(props) {
    ...
    return (
        <HomeContainer>
            ...
            <NavBar/>
            <ContentContainer>
                <p>레이저는 1960년 처음 개발된 이후 우수한 특성으로 인해 산업, 군사, 의료, 학문 등 광범위한 분야에서 사용되고 있으며 최근에는 4차 산업혁명의 시대를 맞아 필수적인 기반
                    기술로서 그 중요성과 응용 분야는 점점 넓어지고 있다. 이에 맞추어 첨단레이저 연구실에서는 여러 가지 종류의 고출력 첨단 고체 레이저 시스템을 연구, 개발하고 있다. 주요 연구
                    분야는 고출력 고체 레이저, 광섬유 레이저, 하이브리드 레이저 등 다양한 고체 레이저 시스템에서 레이저의 근본 현상 탐구 및 발진 특성 연구, 수 W에서 >1 kW에 이르는
